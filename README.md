...
#### [PC Shop Management System](https://github.com/Shahriar-Mahmud-Toha/PC_Shop_Management_System_Desktop_Application)
**Tech Stack:** C#, MSSQL  
**Features:**  
...
<details>
  ...
  <ul>
    <li>Academic projects in C, C++, Java, C#, Python, PHP, ASP.NET, and NestJS</li>
    <li>Proficient in setting up CI/CD pipelines, domain configuration, and secure deployments</li>
    <li>Enjoy collaborating, sharing knowledge, and continuous self-improvement</li>
  </ul>
</details>
